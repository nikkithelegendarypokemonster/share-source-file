...
class Row extends _inferno2.BaseInfernoComponent {
  render() {
    ...
    return (0, _inferno.createVNode)(1, "tr", className, [hasLeftVirtualCell && leftVirtualCellCount != null && (0, _index.splitNumber)(leftVirtualCellCount, MAX_COL_SPAN).map(
    // @ts-ignore
    (colSpan, index) => (0, _inferno.createComponentVNode)(2, _virtual_cell.VirtualCell, {
    ...
    })), children, hasRightVirtualCell && rightVirtualCellCount != null && (0, _index.splitNumber)(rightVirtualCellCount, MAX_COL_SPAN).map(
    // @ts-ignore
    (colSpan, index) => (0, _inferno.createComponentVNode)(2, _virtual_cell.VirtualCell, {
