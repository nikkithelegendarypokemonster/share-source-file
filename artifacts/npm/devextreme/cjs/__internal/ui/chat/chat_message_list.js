/**
* DevExtreme (cjs/__internal/ui/chat/chat_message_list.js)
* Version: 24.2.0
...
var _chat_message_group = _interopRequireDefault(require("./chat_message_group"));
...
class MessageList extends _widget.default {
  ...
  _initMarkup() {
    (0, _renderer.default)(this.element()).addClass(CHAT_MESSAGE_LIST_CLASS);
    super._initMarkup();
  ...
  _createMessageGroupComponent(items, userId) {
    ...
    const messageGroup = this._createComponent($messageGroup, _chat_message_group.default, {
      items,
  ...
  _renderScrollable() {
    this._scrollable = this._createComponent(this._$content, _ui.default, {
      useNative: true
    });
  }
  _renderMessageListContent() {
    ...
    this._$content = (0, _renderer.default)('<div>').appendTo(this.$element());
  ...
  _scrollContentToLastMessageGroup() {
    ...
    if (!((_this$_messageGroups3 = this._messageGroups) !== null && _this$_messageGroups3 !== void 0 && _this$_messageGroups3.length && (0, _window.hasWindow)())) {
      return;
    }
