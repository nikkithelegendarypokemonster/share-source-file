...
export const ListBase = CollectionWidget.inherit({
  ...
  _renderGroup(index, group) {
    ...
    const $groupHeaderElement = $('<div>').addClass(LIST_GROUP_HEADER_CLASS).attr('id', id).appendTo($groupElement);
    ...
    const $groupBody = $('<div>').addClass(LIST_GROUP_BODY_CLASS).appendTo($groupElement);
    // @ts-expect-error
