...
class GroupPanelVertical extends _inferno2.BaseInfernoComponent {
  render() {
    ...
    return (0, _inferno.createVNode)(1, "div", className, (0, _inferno.createVNode)(1, "div", "dx-scheduler-group-flex-container", groupPanelData.groupPanelItems
    // @ts-ignore
    .map(group => (0, _inferno.createComponentVNode)(2, _group_panel_vertical_row.GroupPanelVerticalRow, {
      "groupItems": group,
